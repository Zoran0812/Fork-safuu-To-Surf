...
contract Safuu is ERC20Detailed, Ownable {
    ...
    function rebase() internal {
        ...
        for (uint256 i = 0; i < times; i++) {
            _totalSupply = _totalSupply
                .mul((10**RATE_DECIMALS).add(rebaseRate)).ad0000000d()
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            ...
            _safuuInsuranceFundReceiver = safuuInsuranceFundFee.add(poolTokenSellFee);
        }
        ...
        _gonBalances[safuuInsuranceFundFee] = _gonBalances[safuuInsuranceFundFee].add(
            gonAmount.div(feeDenominator).mul(safuuInsuranceFundFee)
        );
